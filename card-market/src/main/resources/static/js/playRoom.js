$(document ).ready(function(){
	...
	$.ajax({
		url: "http://localhost:8084/RoomService/getBet/" + Roomid,
		type:"GET",
		async: false,
	...
	$.ajax({
		url: "http://localhost:8084/RoomService/joueurs/" + Roomid,
		type:"GET",
		async: false,
		success: function(data){
			var ids = data.split("/");
	...
	$.ajax({
		url: "http://localhost:8081/UserService/getName/" + ennemyId,
		type:"GET",
		async: false,
		success: function(data){
	...
	$.ajax({
		url: "http://localhost:8085/Play/GetCards/" + Roomid + "/" + values.id,
		type:"GET",
		async: false,
		success: function(data){
	...
	$.ajax({
		url: "http://localhost:8085/Play/GetCardsResult/" + Roomid + "/" + values.id,
		type:"GET",
		async: false,
		success: function(data){
	...
	$.ajax({
		url: "http://localhost:8085/Play/GetCards/" + Roomid + "/" + ennemyId,
		type:"GET",
		async: false,
		success: function(data){
	...
	$.ajax({
		url: "http://localhost:8085/Play/GetCardsResult/" + Roomid + "/" + ennemyId,
		type:"GET",
		async: false,
		success: function(data){
	...
	$.ajax({
		url: "http://localhost:8085/Play/GetResults/" + Roomid ,
		type:"GET",
		async: false,
		success: function(data){
			results = data.split("/");
	...
	var  interval = function(){
		   ...
		   if(id > 9){
			   ...
			   if(results[5] == values.id.toString()){
				   ...
				   var bet = roomBet * 2;
				   $.ajax({
		    			  url:"http://localhost:8081/UserService/addMoney/"+ values.id + "/" + bet,
		    			  type:"GET",
		    			  async: false,
		    			  success : function(){
		    				  return;
